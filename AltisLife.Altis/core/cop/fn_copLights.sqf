...
switch (typeOf _vehicle) do
{
	...
	case "B_MRAP_01_F": 				{			_lightleft lightAttachObject [_vehicle, [-0.50,1.5,-0.68]]; 	};	
	...
	case "B_MRAP_01_hmg_F": 			{ 			_lightleft lightAttachObject [_vehicle, [-0.50,1.5,-0.68]]; 	};	
...
switch (typeOf _vehicle) do
{
	...
	case "B_MRAP_01_F": 				{			_lightright lightAttachObject [_vehicle, [0.50,1.5,-0.68]];		};	
	...
	case "I_MRAP_03_hmg_F": 			{ 			_lightright lightAttachObject [_vehicle, [0.50,1.5,-0.68]]; 	};
	case "I_MRAP_03_F":					{			_lightright lightAttachObject [_vehicle, [0.50,1.5,-0.68]]; 	};	
	case "B_APC_Wheeled_01_cannon_F": 	{ 			_lightright lightAttachObject [_vehicle, [1, -2.8, 0.55]]; 		};	
	case "B_MRAP_01_hmg_F": 			{ 			_lightright lightAttachObject [_vehicle, [0.50,1.5,-0.68]];		};	
