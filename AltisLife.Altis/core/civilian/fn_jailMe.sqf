...
switch (true) do
{
	...
	{
		life_is_arrested = false;
		hint "Du bist aus dem Gefängnis ausgebrochen! Deine vorherigen Straftaten bleiben erhalten.";
		[[0,"%1 ist aus dem Gefängnis ausgebrochen!",true,[profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
